export default function Contact() {
    return (
        <section id="contact" className="mb-10">
            ...
            <p className="text-center text-l mb-5 text-stone-700">I'm currently looking for frontend internship opportunities. feel free to reach out, i'd love to talk.</p>
